...
if [ ! -f configure ]; then
  ...
  PATH=$HOME/crossbridge/sdk/usr/bin:$PATH ./configure --disable-oggtest --with-ogg=$dir/libogg --with-ogg-libraries=$dir/libogg/src/.libs --disable-asm --disable-examples
fi
